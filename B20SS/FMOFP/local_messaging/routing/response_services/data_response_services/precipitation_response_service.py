            ...
            if success:
                try:
                    ...
                    if display_handler:
                        ...
                        logger.debug("[LOC_PRECIP_RPNS_SERV_PRECIP_FLOW] Could not get display message handler")
                except Exception as e:
                    logger.debug(f"[LOC_PRECIP_RPNS_SERV_PRECIP_FLOW] Error sending directly to display system: {e}")
                    logger.error(traceback.format_exc())
